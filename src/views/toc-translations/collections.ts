...
export const itemsCollection = buildCollection({
    ...
    properties: {
        ...
        bold: { dataType: "boolean", name: "גופן מודגש" },
        centerAlign: { dataType: "boolean", name: "מיושר לאמצע" },
        lineLine: { dataType: "boolean", name: "שורה שורה" },
        red: { dataType: "boolean", name: "טקסט אדום" },
        justifyBlock: { dataType: "boolean", name: "יישור בלוק" },
        noSpace: { dataType: "boolean", name: "ללא רווח" },
        block: { dataType: "boolean", name: "פיסקה" },
        role: { dataType: "string", name: "תפקיד" },
        reference: { dataType: "string", name: "מקורות" },

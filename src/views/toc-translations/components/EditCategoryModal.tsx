        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" dir="rtl">
            <div className="bg-white rounded-lg shadow-xl w-[450px] flex flex-col overflow-hidden">
                <div className="flex items-center justify-between px-4 py-3 border-b bg-gray-50">
                    <h2 className="font-bold text-sm">עריכת קטגוריה: {initialCategory?.id ?? ""}</h2>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    {isBase ? (
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="block text-[10px] font-semibold mb-1">שם הקטגוריה (עברית) *</label>
                                <input
                                    type="text"
                                    value={nameHe}
                        ...
                        <div>
                            <label className="block text-[10px] font-semibold mb-1">שם הקטגוריה בתרגום זה *</label>
                            <input
                                type="text"
                                value={name}

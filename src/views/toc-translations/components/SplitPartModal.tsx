        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" dir="rtl">
            <div className="bg-white rounded-lg shadow-xl w-[600px] max-h-[90vh] flex flex-col overflow-hidden">
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b bg-gray-50">
                    <h2 className="font-bold text-lg">פיצול מקטע: {currentPart?.id}</h2>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 text-base">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="block text-sm font-semibold mb-1">שם המקטע החדש (עברית) *</label>
                            <input
                                type="text"
                                value={nameHe}
                    ...
                    <div className="border rounded p-3 space-y-2">
                        <div className="text-sm font-semibold text-gray-600">תנאי תצוגה (ממולא מהמקטע הנוכחי)</div>
                    ...
                    <div className="flex gap-4">
                        <label className="flex items-center gap-1.5 cursor-pointer">
                            ...
                            />
                            <span className="text-base">המקטע החדש <strong>אחרי</strong> הנוכחי</span>
                        </label>
                        <label className="flex items-center gap-1.5 cursor-pointer">
                            <input
                                type="radio"
                            ...
                            />
                            <span className="text-base">המקטע החדש <strong>לפני</strong> הנוכחי</span>
                        </label>
                    </div>

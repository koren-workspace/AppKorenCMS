            ...
            <div className="w-28 shrink-0 flex flex-col gap-1 bg-white p-1 border-l overflow-auto">
                ...
                {translations.map((translation: any, index: number) => (
                    <div key={translation.translationId ?? index} className="flex items-center gap-0.5">
                        <button
                            ...
                            className={`flex-1 text-right p-1.5 rounded border ${selectedTranslationIndex === index ? "bg-purple-600 text-white" : "bg-gray-50"}`}
                        >
                ...
                {selectedTocId && onAddTranslation && getSuggestedTranslationId && (
                    <button
                        ...
                        className="mt-1 py-1.5 rounded border-2 border-dashed border-purple-200 text-purple-600 font-bold text-[9px] hover:bg-purple-50"
                    >
                        + הוסף תרגום
                    </button>
                )}
